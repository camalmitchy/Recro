...
const SERVICES: ServiceDef[] = [
  ...
  { key: "children", label: "Children & Adolescents", description: "50-minute session tailored for young clients.", duration: "50 min", durationMin: 50, amount: 6000 },
                ...
                {SERVICES.map((s) => {
                  ...
                  return (
                    <button
                      ...
                      className={`text-left rounded-2xl border bg-card p-6 md:p-7 transition shadow-[var(--shadow-soft)] hover:border-primary ${
                    ...
                    return (
                      <button
                        ...
                        className={`text-left rounded-2xl border p-5 transition ${
                          sel ? "border-primary ring-1 ring-primary bg-background" : "border-border bg-card hover:border-primary"
                        }`}
                      >
                    ...
                    {dateStrip.map((d) => {
                      ...
                      return (
                        <button
                          ...
                          className={`shrink-0 w-[88px] rounded-2xl border px-3 py-3 text-center transition ${
                            sel
    ...
    <div>
      ...
      <div className="mt-5 grid sm:grid-cols-2 gap-4">
        <button
          ...
          className={`text-left rounded-2xl border p-5 transition ${
            method === "mpesa" ? "border-primary ring-1 ring-primary bg-background" : "border-border bg-card hover:border-primary"
          }`}
        >
        ...
        <button
          ...
          className={`text-left rounded-2xl border p-5 transition ${
            method === "bank" ? "border-primary ring-1 ring-primary bg-background" : "border-border bg-card hover:border-primary"
          }`}
        >
          <div className="flex items-center gap-2.5 font-semibold">
