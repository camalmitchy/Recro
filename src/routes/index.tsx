...
function HomePage() {
  return (
    <SiteShell>
      ...
      {/* BEGIN HEALING — quick booking - Section 4 */}
      ...
      {/* WHY RECRO — trust strip - Section 5 */}
