...
function CampPage() {
  return (
    <SiteShell>
      ...
      {/* UNDERSTANDING THE JOURNEY - Section 1 */}
      ...
      {/* 2026 PRICING - Section 3 */}
      <ScrollRevealSection index={3}>
        <section id="pricing" className="container-page pb-16 bg-background">
      ...
      {/* PAYMENT OPTIONS - Section 4 */}
      <ScrollRevealSection index={4}>
        <section className="container-page pb-16 bg-background">
